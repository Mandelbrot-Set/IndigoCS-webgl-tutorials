...
// Source: https://www.shadertoy.com/view/MdfGRr
// Features:
// A Julia-bulb implementation. Two tricks worth noting:
// [1] it doesn't use pow() functions to compute complex number powers, but it uses algebra instead.
// [2] the distance estimator (DE) is analytic, not based on numerically computed gradient.
