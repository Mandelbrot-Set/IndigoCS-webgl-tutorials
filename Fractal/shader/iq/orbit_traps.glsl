...
// Some orbit trap coloring in the Maldebrot set. There are two traps.
// First one (col1, in blue) is "average trap distance to line".
// The second one (col2, in yellow) is "minimum distance to point".
// The distance to the set (c1, in black) is then multiplied.
